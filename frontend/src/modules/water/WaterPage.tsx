...
export const WaterPage: React.FC = () => {
  ...
  const fetchWaterData = async () => {
    try {
      setLoading(true);
const res = await fetch('https://ai-powered-smart-city-integration.onrender.com/api/v1/water/latest');
const sumRes = await fetch('https://ai-powered-smart-city-integration.onrender.com/api/v1/water/summary');
      if (res.ok && sumRes.ok) {
